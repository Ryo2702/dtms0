...
@section('content')
    <div class="p-4 sm:p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <button type="button" class="btn btn-primary gap-2" onclick="userModal.showModal()">
        ...
        <x-data-table :headers="['Avatar', 'Employee ID', 'Name', 'Email', 'Department', 'Type', 'Online', 'Status', 'Actions']" :paginator="$users" :sortableFields="['name', 'email', 'type', 'status']" emptyMessage="No users found.">
            @foreach ($users as $user)
                <tr class="hover">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="badge badge-lg">{{ $user->employee_id }}</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        @if ($user->department)
                            <span class="badge badge-primary">{{ $user->department->code }}</span>
                        @else
                            <span class="badge">UKN</span>
                        @endif
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-3">
                        <button onclick="viewUserDetails({{ $user->id }})" class="btn btn-ghost btn-sm btn-link">
                            Details
                        </button>
                        <button onclick="editUser({{ $user->id }})" class="btn btn-ghost btn-sm btn-link">
                            Edit
                        </button>
                    </td>
                </tr>
    ...
    <x-modal id="userModal" title="Create User" size="lg">
        <form id="userForm" action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
            ...
            <div class="form-control">
                ...
                <input type="text" id="name" name="name" required placeholder="e.g., John Doe" class="input input-bordered" />
                @error('name')
                    <label class="label">
            ...
            <div class="form-control">
                ...
                <input type="email" id="email" name="email" required placeholder="e.g., john@example.com" class="input input-bordered" />
                @error('email')
                    <label class="label">
                        <span class="label-text-alt text-error">{{ $message }}</span>
                    </label>
            ...
            <div class="form-control">
                ...
                <select id="department_id" name="department_id" class="select select-bordered">
                ...
                <label class="label">
                    <span class="label-text-alt">Only departments without assigned users are shown</span>
                </label>
                @error('department_id')
                    <label class="label">
                        <span class="label-text-alt text-error">{{ $message }}</span>
            ...
            <div class="form-control">
                ...
                <input type="password" id="password" name="password" required placeholder="Minimum 8 characters" class="input input-bordered" />
                @error('password')
                    <label class="label">
                        <span class="label-text-alt text-error">{{ $message }}</span>
                    </label>
            ...
            <div class="form-control">
                ...
                <input type="password" id="password_confirmation" name="password_confirmation" required placeholder="Confirm password" class="input input-bordered" />
            </div>
            ...
            <div class="form-control">
                ...
                <input type="file" id="avatar" name="avatar" accept="image/*" class="file-input file-input-bordered" />
                <label class="label">
        ...
        @slot('actions')
            <button type="button" class="btn btn-ghost" onclick="userModal.close()">
                Cancel
            </button>
    ...
    <x-modal id="editUserModal" title="Edit User" size="lg">
        <form id="editUserForm" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="form-control">
                ...
                <input type="text" id="edit_name" name="name" required placeholder="e.g., John Doe" class="input input-bordered" />
            </div>
            ...
            <div class="form-control">
                ...
                <input type="email" id="edit_email" name="email" required placeholder="e.g., john@example.com" class="input input-bordered" />
            </div>
            ...
            <div class="form-control">
                ...
                <select id="edit_department_id" name="department_id" class="select select-bordered">
                    <option value="">Select a department</option>
                </select>
                <label class="label">
                    <span class="label-text-alt">Only available departments are shown</span>
                </label>
            </div>
            ...
            <div class="form-control">
                ...
                <input type="password" id="edit_password" name="password" placeholder="Leave empty to keep current password" class="input input-bordered" />
                <label class="label">
            ...
            <div class="form-control">
                ...
                <input type="password" id="edit_password_confirmation" name="password_confirmation" placeholder="Confirm password" class="input input-bordered" />
            </div>
            ...
            <div class="form-control">
                ...
                <input type="file" id="edit_avatar" name="avatar" accept="image/*" class="file-input file-input-bordered" />
                <label class="label">
                    <span class="label-text-alt">Leave empty to keep current avatar. Accepted formats: JPG, PNG, GIF (Max 2MB)</span>
                </label>
            </div>
        ...
        @slot('actions')
            <button type="button" class="btn btn-ghost" onclick="editUserModal.close()">
                Cancel
            </button>
            <button type="submit" form="editUserForm" class="btn btn-primary" id="editSubmitBtn">
                Update User
            </button>
        @endslot
    </x-modal>
    ...
    <x-modal id="detailsUserModal" title="User Details" size="lg">
        <div class="space-y-6">
            ...
            <div class="flex justify-center">
                <div id="details_avatar_container" class="h-24 w-24 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center overflow-hidden text-white font-bold text-2xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <span id="details_employee_id" class="inline-flex items-center px-3 py-1 rounded-full text-sm font-mono font-medium bg-gray-100 text-gray-800"></span>
                </div>
        ...
        @slot('actions')
            <button type="button" class="btn btn-ghost" onclick="detailsUserModal.close()">
                Close
            </button>
