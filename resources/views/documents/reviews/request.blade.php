        ...
        <div class="bg-white shadow-sm rounded-lg">
                    ...
                    <div class="flex items-center space-x-2">
                        <span
                            ...
                            <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M7 16l-4-4m0 0l4-4m-4 4h18" clip-rule="evenodd" />
                            </svg>
                            {{ $receivedReviews->total() }} Total
                        </span>
                    </div>
                </div>
            </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($receivedReviews as $review)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900">{{ $review->originalDepartment->name ?? 'N/A' }}
                                        </div>
                                        <div class="text-sm text-gray-500">
                                            Sent by: {{ $review->creator->name ?? 'N/A' }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
            ...
            @else
                <div class="px-6 py-12 text-center">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900">No received documents</h3>
                    <p class="mt-1 text-sm text-gray-500">You haven't received any documents from other departments yet.</p>
                </div>
            @endif
        </div>
    </div>
